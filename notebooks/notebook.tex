...
First, for data, let's use ages:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k+kr}{default} \PY{p}{(}\PY{k+kt}{Int}\PY{p}{,}\PY{k+kt}{Double}\PY{p}{)}
        
        \PY{n+nf}{ages} \PY{o+ow}{::} \PY{p}{[}\PY{k+kt}{Int}\PY{p}{]}
        \PY{n+nf}{ages} \PY{o+ow}{=} \PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{19}\PY{p}{,}\PY{l+m+mi}{22}\PY{p}{,}\PY{l+m+mi}{25}\PY{p}{,}\PY{l+m+mi}{33}\PY{p}{,}\PY{l+m+mi}{33}\PY{p}{,}\PY{l+m+mi}{39}\PY{p}{,}\PY{l+m+mi}{31}\PY{p}{,}\PY{l+m+mi}{44}\PY{p}{,}\PY{l+m+mi}{41}\PY{p}{,}\PY{l+m+mi}{42}\PY{p}{,}\PY{l+m+mi}{48}\PY{p}{,}\PY{l+m+mi}{55}\PY{p}{,}\PY{l+m+mi}{59}\PY{p}{,}\PY{l+m+mi}{70}\PY{p}{]}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{k+kr}{import} \PY{n+nn}{Graphics.Rendering.Chart}                \PY{p}{(}\PY{k+kt}{PlotValue}\PY{p}{,}\PY{k+kt}{Renderable}
        ...
        \PY{n+nf}{histogram} \PY{l+m+mi}{10} \PY{l+m+mi}{0} \PY{p}{(}\PY{n}{map} \PY{n}{toEnum} \PY{n}{ages}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{k+kr}{import} \PY{n+nn}{Data.Semigroup}      \PY{p}{(}\PY{k+kt}{Semigroup}\PY{p}{(}\PY{o}{..}\PY{p}{)}\PY{p}{)}
        ...
        \PY{k+kr}{import} \PY{n+nn}{Data.Maybe}          \PY{p}{(}\PY{n+nf}{fromMaybe}\PY{p}{,}\PY{n+nf}{fromJust}\PY{p}{)}
        ...
        \PY{k+kr}{instance} \PY{p}{(}\PY{k+kt}{Ord} \PY{n}{a}\PY{p}{,} \PY{k+kt}{Enum} \PY{n}{a}\PY{p}{,} \PY{k+kt}{PrintfArg} \PY{n}{a}\PY{p}{,} \PY{k+kt}{Bounded} \PY{n}{a}\PY{p}{)} \PY{o+ow}{=\PYZgt{}} \PY{k+kt}{Show} \PY{p}{(}\PY{k+kt}{Range} \PY{n}{a}\PY{p}{)} \PY{k+kr}{where}
            \PY{n}{show} \PY{p}{(}\PY{k+kt}{Range} \PY{p}{(}\PY{k+kt}{Just} \PY{n}{l}\PY{p}{)} \PY{p}{(}\PY{k+kt}{Just} \PY{n}{u}\PY{p}{)}\PY{p}{)}
              ...
              \PY{o}{|} \PY{n}{l} \PY{o}{\PYZgt{}=} \PY{n}{u} \PY{o+ow}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{∅}\PY{l+s}{\PYZdq{}}
            \PY{n}{show} \PY{p}{(}\PY{k+kt}{Range} \PY{n}{l} \PY{p}{(}\PY{k+kt}{Just} \PY{n}{u}\PY{p}{)}\PY{p}{)} \PY{o+ow}{=} \PY{n}{printf} \PY{l+s}{\PYZdq{}}\PY{l+s}{[\PYZpc{}v,\PYZpc{}v)}\PY{l+s}{\PYZdq{}} \PY{p}{(}\PY{n}{fromMaybe} \PY{n}{minBound} \PY{n}{l}\PY{p}{)} \PY{n}{u}
            \PY{n}{show} \PY{p}{(}\PY{k+kt}{Range} \PY{n}{l} \PY{k+kt}{Nothing}\PY{p}{)}
              \PY{o}{|} \PY{n}{l} \PY{o}{==} \PY{k+kt}{Just} \PY{n}{maxBound} \PY{o+ow}{=} \PY{n}{printf} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZpc{}v}\PY{l+s}{\PYZdq{}} \PY{p}{(}\PY{n}{maxBound} \PY{p}{`}\PY{n}{asTypeOf}\PY{p}{`} \PY{n}{fromJust} \PY{n}{l}\PY{p}{)}
              \PY{o}{|} \PY{n}{otherwise} \PY{o+ow}{=} \PY{n}{printf} \PY{l+s}{\PYZdq{}}\PY{l+s}{[\PYZpc{}v,\PYZpc{}v]}\PY{l+s}{\PYZdq{}} \PY{p}{(}\PY{n}{fromMaybe} \PY{n}{minBound} \PY{n}{l}\PY{p}{)} \PY{p}{(}\PY{n}{maxBound} \PY{p}{`}\PY{n}{asTypeOf}\PY{p}{`} \PY{n}{fromJust} \PY{n}{l}\PY{p}{)}
        ...
        \PY{n+nf}{singletonRange} \PY{o+ow}{::} \PY{p}{(}\PY{k+kt}{Enum} \PY{n}{a}\PY{p}{,} \PY{k+kt}{Bounded} \PY{n}{a}\PY{p}{,} \PY{k+kt}{Eq} \PY{n}{a}\PY{p}{)} \PY{o+ow}{=\PYZgt{}} \PY{n}{a} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Range} \PY{n}{a}
        \PY{n+nf}{singletonRange} \PY{n}{x}
          \PY{o}{|} \PY{n}{x} \PY{o}{==} \PY{n}{maxBound} \PY{o+ow}{=} \PY{k+kt}{Range} \PY{p}{(}\PY{k+kt}{Just} \PY{n}{x}\PY{p}{)} \PY{k+kt}{Nothing}
          \PY{o}{|} \PY{n}{otherwise} \PY{o+ow}{=} \PY{k+kt}{Range} \PY{p}{(}\PY{k+kt}{Just} \PY{n}{x}\PY{p}{)} \PY{p}{(}\PY{k+kt}{Just} \PY{p}{(}\PY{n}{succ} \PY{n}{x}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
anonymity:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n+nf}{k2ages} \PY{o+ow}{=} \PY{k+kt}{PrivateHuffman} \PY{l+m+mi}{2} \PY{n}{singletonRange}
...
unsatisfactory generalizations. The anonymization produced is as
follows:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{k+kr}{import} \PY{k}{qualified} \PY{n+nn}{Data.Map.Strict}         \PY{k}{as} \PY{n}{Map}
         \PY{k+kr}{import}           \PY{n+nn}{Data.Semigroup}          \PY{p}{(}\PY{k+kt}{Semigroup}\PY{p}{(}\PY{o}{..}\PY{p}{)}\PY{p}{)}
         \PY{k+kr}{import}           \PY{n+nn}{Data.Semigroup.Foldable} \PY{p}{(}\PY{n+nf}{foldMap1}\PY{p}{)}
         \PY{k+kr}{import}           \PY{n+nn}{Data.Foldable}           \PY{p}{(}\PY{n+nf}{foldl\PYZsq{}}\PY{p}{)}
         \PY{k+kr}{import}           \PY{n+nn}{IHaskell.Display}        \PY{p}{(}\PY{k+kt}{IHaskellDisplay}\PY{p}{(}\PY{n+nf}{display}\PY{p}{)}
                                                  \PY{p}{,}\PY{n+nf}{html}\PY{p}{,}\PY{k+kt}{Display}\PY{p}{)}
         \PY{k+kr}{import}           \PY{n+nn}{Text.Printf}             \PY{p}{(}\PY{n+nf}{printf}\PY{p}{)}
         
         \PY{k+kr}{newtype} \PY{k+kt}{AnonTable} \PY{n}{a} \PY{n}{b}
             \PY{o+ow}{=} \PY{k+kt}{AnonTable}
             \PY{p}{\PYZob{}} \PY{n}{getAnonTable} \PY{o+ow}{::} \PY{p}{[}\PY{p}{(}\PY{n}{a}\PY{p}{,}\PY{n}{b}\PY{p}{)}\PY{p}{]}
             \PY{p}{\PYZcb{}}
         
         \PY{n+nf}{buildAnonTable} \PY{o+ow}{::} \PY{p}{(}\PY{k+kt}{Ord} \PY{n}{a}\PY{p}{,} \PY{k+kt}{Semigroup} \PY{n}{b}\PY{p}{)}
                        \PY{o+ow}{=\PYZgt{}} \PY{k+kt}{PrivateHuffman} \PY{n}{a} \PY{n}{b} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{p}{[}\PY{n}{a}\PY{p}{]} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{AnonTable} \PY{n}{a} \PY{n}{b}
         \PY{n+nf}{buildAnonTable} \PY{p}{(}\PY{k+kt}{PrivateHuffman} \PY{n}{k} \PY{n}{f} \PY{n}{xs}\PY{p}{)}
             \PY{o+ow}{=} \PY{k+kt}{AnonTable} \PY{o}{.} \PY{n}{map} \PY{p}{(}\PY{n+nf}{\PYZbs{}}\PY{n}{x} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{m} \PY{k+kt}{Map}\PY{o}{.!} \PY{n}{x}\PY{p}{)}\PY{p}{)}
           \PY{k+kr}{where}
             \PY{n}{m} \PY{o+ow}{=} \PY{n}{go} \PY{n}{xs}
             \PY{n}{go} \PY{p}{(}\PY{k+kt}{Leaf} \PY{k+kr}{\PYZus{}} \PY{n}{x}\PY{p}{)} \PY{o+ow}{=} \PY{k+kt}{Map}\PY{o}{.}\PY{n}{singleton} \PY{n}{x} \PY{p}{(}\PY{n}{f} \PY{n}{x}\PY{p}{)}
             \PY{n}{go} \PY{n}{nd}\PY{o}{@}\PY{p}{(}\PY{k+kt}{Node} \PY{n}{i} \PY{n}{l} \PY{n}{r}\PY{p}{)}
               \PY{o}{|} \PY{n}{size} \PY{n}{l} \PY{o}{\PYZgt{}=} \PY{n}{k} \PY{o}{\PYZam{}\PYZam{}} \PY{n}{size} \PY{n}{r} \PY{o}{\PYZgt{}=} \PY{n}{k} \PY{o+ow}{=} \PY{n}{go} \PY{n}{l} \PY{o}{\PYZlt{}\PYZgt{}} \PY{n}{go} \PY{n}{r}
               \PY{o}{|} \PY{n}{otherwise} \PY{o+ow}{=}
                   \PY{n}{foldl\PYZsq{}} \PY{p}{(}\PY{n+nf}{\PYZbs{}}\PY{n}{mp} \PY{n}{v} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Map}\PY{o}{.}\PY{n}{insert} \PY{n}{v} \PY{n}{summary} \PY{n}{mp}\PY{p}{)} \PY{k+kt}{Map}\PY{o}{.}\PY{n}{empty} \PY{n}{nd}
               \PY{k+kr}{where} \PY{n}{summary} \PY{o+ow}{=} \PY{n}{foldMap1} \PY{n}{f} \PY{n}{nd}
         
         \PY{k+kr}{instance} \PY{p}{(}\PY{k+kt}{Show} \PY{n}{a}\PY{p}{,} \PY{k+kt}{Show} \PY{n}{b}\PY{p}{)} \PY{o+ow}{=\PYZgt{}} \PY{k+kt}{IHaskellDisplay} \PY{p}{(}\PY{k+kt}{AnonTable} \PY{n}{a} \PY{n}{b}\PY{p}{)} \PY{k+kr}{where}
             \PY{n}{display} \PY{p}{(}\PY{k+kt}{AnonTable} \PY{n}{xs}\PY{p}{)} \PY{o+ow}{=} \PY{n}{pure} \PY{p}{(}\PY{k+kt}{Display} \PY{p}{[}\PY{n}{html} \PY{p}{(}\PY{n}{go} \PY{n}{xs}\PY{p}{)}\PY{p}{]}\PY{p}{)}
               \PY{k+kr}{where}
                 \PY{n}{go} \PY{n}{tb}
                     \PY{o+ow}{=} \PY{n}{unlines} \PY{o}{\PYZdl{}}
                     \PY{p}{[} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZlt{}table\PYZgt{}}\PY{l+s}{\PYZdq{}}
                     \PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZlt{}tr\PYZgt{}\PYZlt{}th\PYZgt{}Original\PYZlt{}/th\PYZgt{}\PYZlt{}th\PYZgt{}Anonymized\PYZlt{}/th\PYZgt{}\PYZlt{}/tr\PYZgt{}}\PY{l+s}{\PYZdq{}} \PY{p}{]} \PY{o}{++}
                     \PY{p}{[} \PY{n}{printf} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZlt{}tr\PYZgt{}\PYZlt{}td\PYZgt{}\PYZpc{}s\PYZlt{}/td\PYZgt{}\PYZlt{}td\PYZgt{}\PYZpc{}s\PYZlt{}/td\PYZgt{}\PYZlt{}/tr\PYZgt{}}\PY{l+s}{\PYZdq{}} \PY{p}{(}\PY{n}{show} \PY{n}{x}\PY{p}{)} \PY{p}{(}\PY{n}{show} \PY{n}{y}\PY{p}{)}
                     \PY{o}{|} \PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{)} \PY{o+ow}{\PYZlt{}\PYZhy{}} \PY{n}{tb} \PY{p}{]} \PY{o}{++}
                     \PY{p}{[} \PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZlt{}/table\PYZgt{}}\PY{l+s}{\PYZdq{}} \PY{p}{]}
         
         \PY{n+nf}{buildAnonTable} \PY{n}{k2ages} \PY{n}{ages}
\end{Verbatim}
...
Huffman tree \cite{2201627/M35JL7I9}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k+kr}{import}           \PY{n+nn}{Control.Monad.State}
         \PY{k+kr}{import} \PY{k}{qualified} \PY{n+nn}{Data.Map.Strict}     \PY{k}{as} \PY{n}{Map}
         ...
         \PY{n+nf}{k2agesAlph} \PY{o+ow}{=} \PY{k+kt}{PrivateHuffman} \PY{l+m+mi}{2} \PY{n}{singletonRange} \PY{p}{(}\PY{n}{buildAlphHuffman} \PY{p}{(}\PY{n}{frequencies} \PY{n}{ages}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{k2agesAlph}
         \PY{n+nf}{buildAnonTable} \PY{n}{k2agesAlph} \PY{n}{ages}
\end{Verbatim}
...
binary tree to count the cumulative frequencies:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k+kr}{import} \PY{n+nn}{Data.Bits}
...
until} the point where \(k\) is no longer satisfied:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{n+nf}{follow} \PY{o+ow}{::} \PY{k+kt}{Int} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Word} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Perfect} \PY{n}{a} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Span}
...
\(0\) and \(4\):
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n+nf}{smallVals} \PY{o+ow}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]}
...
[1,2,1,3,2,0,1,0,3]
    ...
    \hypertarget{incremental-anonymity}{%
\section{Incremental Anonymity}\label{incremental-anonymity}}

Incrementally anonymizing a database can potentially leak private data
\cite{2201627/HWXFFBRT}. For instance, take the following values:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n+nf}{incrementalTree} \PY{o+ow}{=} \PY{k+kt}{PrivateHuffman} \PY{l+m+mi}{2} \PY{n}{singletonRange} \PY{p}{(}\PY{n}{buildAlphHuffman} \PY{p}{(}\PY{n}{frequencies} \PY{p}{[}\PY{l+m+mi}{1}\PY{o}{..}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{incrementalTable} \PY{o+ow}{=} \PY{n}{buildAnonTable} \PY{n}{incrementalTree} \PY{p}{[}\PY{l+m+mi}{1}\PY{o}{..}\PY{l+m+mi}{5}\PY{p}{]}
         \PY{n+nf}{incrementalTable}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n+nf}{nextTree} \PY{o+ow}{=} \PY{k+kt}{PrivateHuffman} \PY{l+m+mi}{2} \PY{n}{singletonRange} \PY{p}{(}\PY{n}{buildAlphHuffman} \PY{p}{(}\PY{n}{frequencies} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{nextTable} \PY{o+ow}{=} \PY{n}{buildAnonTable} \PY{n}{nextTree} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]}
         \PY{n+nf}{nextTable}
\end{Verbatim}
    ...
    If both of these anonymizations are released, we could take their
row-wise intersection, thereby revealing much more information than we
intended.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k+kr}{import} \PY{n+nn}{Data.Semigroup} \PY{p}{(}\PY{k+kt}{Max}\PY{p}{(}\PY{o}{..}\PY{p}{)}\PY{p}{,}\PY{k+kt}{Min}\PY{p}{(}\PY{o}{..}\PY{p}{)}\PY{p}{,}\PY{k+kt}{Option}\PY{p}{(}\PY{o}{..}\PY{p}{)}\PY{p}{,}\PY{p}{(}\PY{o}{\PYZlt{}\PYZgt{}}\PY{p}{)}\PY{p}{)}
         \PY{k+kr}{import} \PY{n+nn}{Data.Function}  \PY{p}{(}\PY{n+nf}{on}\PY{p}{)}
         
         \PY{n+nf}{intersection} \PY{o+ow}{::} \PY{k+kt}{Ord} \PY{n}{a} \PY{o+ow}{=\PYZgt{}} \PY{k+kt}{Range} \PY{n}{a} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Range} \PY{n}{a} \PY{o+ow}{\PYZhy{}\PYZgt{}} \PY{k+kt}{Range} \PY{n}{a}
         \PY{n+nf}{intersection} \PY{p}{(}\PY{k+kt}{Range} \PY{n}{lx} \PY{n}{ux}\PY{p}{)} \PY{p}{(}\PY{k+kt}{Range} \PY{n}{ly} \PY{n}{uy}\PY{p}{)}
             \PY{o+ow}{=} \PY{k+kt}{Range}
                 \PY{p}{(}\PY{p}{(}\PY{n}{fmap} \PY{n}{getMax} \PY{o}{.} \PY{n}{getOption}\PY{p}{)} \PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{o}{\PYZlt{}\PYZgt{}}\PY{p}{)} \PY{p}{`}\PY{n}{on}\PY{p}{`} \PY{p}{(}\PY{k+kt}{Option} \PY{o}{.} \PY{n}{fmap} \PY{k+kt}{Max}\PY{p}{)}\PY{p}{)} \PY{n}{lx} \PY{n}{ly}\PY{p}{)}\PY{p}{)}
                 \PY{p}{(}\PY{p}{(}\PY{n}{fmap} \PY{n}{getMin} \PY{o}{.} \PY{n}{getOption}\PY{p}{)} \PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{o}{\PYZlt{}\PYZgt{}}\PY{p}{)} \PY{p}{`}\PY{n}{on}\PY{p}{`} \PY{p}{(}\PY{k+kt}{Option} \PY{o}{.} \PY{n}{fmap} \PY{k+kt}{Min}\PY{p}{)}\PY{p}{)} \PY{n}{ux} \PY{n}{uy}\PY{p}{)}\PY{p}{)}
         
         \PY{k+kt}{AnonTable} \PY{p}{(}\PY{n}{zip} \PY{p}{[}\PY{l+m+mi}{1}\PY{o}{..}\PY{p}{]} \PY{p}{(}\PY{p}{(}\PY{n}{zipWith} \PY{p}{(}\PY{n}{intersection} \PY{p}{`}\PY{n}{on}\PY{p}{`} \PY{n}{snd}\PY{p}{)} \PY{p}{`}\PY{n}{on}\PY{p}{`} \PY{n}{getAnonTable}\PY{p}{)} \PY{n}{incrementalTable} \PY{n}{nextTable}\PY{p}{)}\PY{p}{)}
\end{Verbatim}


    
    
    The solution might seem simple: just don't change the anonymization of
previous entries. But this is actually sub-optimal, leaving earlier more
conservative than they need to be.

The problem is related to \emph{tree-balancing}. For search trees, we
want to balance to reduce search cost, but reduce the frequency of
balancing to reduce insertion cost: here, we want to balance to increase
information gain, but reduce frequency of balancing to avoid revealing
private internal structure.

It's worth noting that we're not concerned with the overall frequency of
balances, rather the rebalancing per release. After all, if we only
release one copy of the anonymized data set, we need not be concerned
with incremental privacy at all.

    \hypertarget{generalized-balance}{%
\section{Generalized Balance}\label{generalized-balance}}

In the previous section, we saw that we could generalize the ``cost of
rebalancing'' to describe incremental anonymity. Other notions from the
theory of search trees can be generalized similarly, in particular
\emph{balance}.

One generalization applies to \(l\)-diversity \cite{2201627/E9354EJL}.

Let's take a database with a sensitive row, perhaps voting preference:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{k+kr}{import} \PY{n+nn}{Control.Arrow} \PY{p}{(}\PY{p}{(}\PY{o}{***}\PY{p}{)}\PY{p}{)}
         \PY{k+kr}{import} \PY{n+nn}{Text.Printf}   \PY{p}{(}\PY{k+kt}{PrintfArg}\PY{p}{(}\PY{o}{..}\PY{p}{)}\PY{p}{,}\PY{n+nf}{formatChar}\PY{p}{)}
         
         \PY{k+kr}{data} \PY{k+kt}{VotingPref}
             \PY{o+ow}{=} \PY{k+kt}{D}
             \PY{o}{|} \PY{k+kt}{R}
             \PY{k+kr}{deriving} \PY{p}{(}\PY{k+kt}{Show}\PY{p}{,}\PY{k+kt}{Eq}\PY{p}{,}\PY{k+kt}{Ord}\PY{p}{,}\PY{k+kt}{Enum}\PY{p}{,}\PY{k+kt}{Bounded}\PY{p}{)}
         
         \PY{k+kr}{instance} \PY{k+kt}{PrintfArg} \PY{k+kt}{VotingPref} \PY{k+kr}{where}
             \PY{n}{formatArg} \PY{k+kt}{D} \PY{o+ow}{=} \PY{n}{formatChar} \PY{l+s+sc}{\PYZsq{}D\PYZsq{}}
             \PY{n}{formatArg} \PY{k+kt}{R} \PY{o+ow}{=} \PY{n}{formatChar} \PY{l+s+sc}{\PYZsq{}R\PYZsq{}}
         
         \PY{n+nf}{agesAndVotes} \PY{o+ow}{=} \PY{n}{zip} \PY{n}{ages} \PY{p}{[}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{R}\PY{p}{,}\PY{k+kt}{D}\PY{p}{,}\PY{k+kt}{D}\PY{p}{]}
         \PY{n+nf}{agesAndVotesTree} \PY{o+ow}{=} \PY{k+kt}{PrivateHuffman} \PY{l+m+mi}{2} \PY{p}{(}\PY{n}{singletonRange} \PY{o}{***} \PY{n}{singletonRange}\PY{p}{)} \PY{p}{(}\PY{n}{buildAlphHuffman} \PY{p}{(}\PY{n}{frequencies} \PY{n}{agesAndVotes}\PY{p}{)}\PY{p}{)}
         \PY{n+nf}{agesAndVotesTable} \PY{o+ow}{=} \PY{n}{buildAnonTable} \PY{n}{agesAndVotesTree} \PY{n}{agesAndVotes}
         \PY{n+nf}{agesAndVotesTree}
         \PY{n+nf}{agesAndVotesTable}
\end{Verbatim}
