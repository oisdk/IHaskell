...
median3 :: (a -> a -> Bool) -> a -> a -> a -> a
median3 cmp _0 _1 _2
    = swap2 cmp _1 _2 $ \ _1 _2 ->
      swap2 cmp _0 _2 $ \ _0 _2 ->
      swap2 cmp _0 _1 $ \ _0 _1 ->
      _1
...
sort3T :: (a -> a -> Bool) -> (a, a, a) -> (a, a, a)
sort3T cmp (x,y,z) = sort3 cmp x y z
{-# INLINE sort3T #-}
...
median4 :: (a -> a -> Bool) -> a -> a -> a -> a -> a
median4 cmp _0 _1 _2 _3
    = swap2 cmp _0 _1 $ \ _0 _1 ->
      swap2 cmp _2 _3 $ \ _2 _3 ->
      swap2 cmp _0 _2 $ \ _0 _2 ->
      swap2 cmp _1 _3 $ \ _1 _3 ->
...
sort4T :: (a -> a -> Bool) -> (a, a, a, a) -> (a, a, a, a)
sort4T cmp (w,x,y,z) = inline sort4 cmp w x y z
{-# INLINE sort4T #-}
...
sort5T :: (a -> a -> Bool) -> (a,a,a,a,a) -> (a,a,a,a,a)
sort5T cmp (v,w,x,y,z) = inline sort5 cmp v w x y z
{-# INLINE sort5T #-}

median5 :: (a -> a -> Bool) -> a -> a -> a -> a -> a -> a
median5 cmp _0 _1 _2 _3 _4
    = swap2 cmp _0 _1 $ \ _0 _1 ->
      swap2 cmp _2 _3 $ \ _2 _3 ->
      swap2 cmp _0 _2 $ \ _0 _2 ->
      swap2 cmp _1 _3 $ \ _1 _3 ->
